...
<body>
    <form id="form1" runat="server">
        <div class="cal">
            ...
            <asp:Button ID="sub" Text="-" runat="server" Height="37px" Style="margin-left:0px; margin-top:0px"
            ...
            <asp:Button ID="mul" Text="*" runat="server" Height="37px" Style="margin-left:0px; margin-top:0px"
            ...
            <asp:Button ID="div" Text="/" runat="server" Height="37px" Style="margin-left:0px; margin-top:0px"
